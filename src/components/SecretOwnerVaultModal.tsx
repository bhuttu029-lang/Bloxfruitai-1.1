                  ...
                  <div className="space-y-2 pt-1">
                    ...
                    <div className="flex items-center justify-between gap-3 pt-2">
                      <button
                        ...
                        className="px-4 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-xs text-slate-400 hover:text-white font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 disabled:opacity-50 text-xs text-cyan-400 hover:text-cyan-300 font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
                      >
              ...
              <div className="max-w-md mx-auto py-8 text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    Mandatory 3-Factor verification: Pre-Authorization Clearance Code, Master Clearance Key, and 6-Digit Gmail OTP.
                  </p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-3.5 text-left">
                  ...
                  <div>
                    <label className="text-[11px] font-bold text-amber-300 uppercase tracking-wider flex items-center justify-between mb-1.5">
                      <span>Step 1: Pre-Authorization Clearance Code</span>
                  ...
                  <div className="space-y-2 pt-1">
                    ...
                    >
                      <Unlock className="w-4 h-4" />
                      <span>Proceed to Step 3 (Mandatory OTP)</span>
                    </button>
                  </div>
                </form>
